...
const Blockpost = () => {
 ...
 const handleSidebarToggle = () => {
  ...
  <i className="fas fa-bars" />
               ...
               {isAuthenticated ? (
                 <>
                  <li className="header-menu" style={{ color: 'red' }}>
                   ...
                   <li>
                     <Link className="dropdown-item" to="/pages/administracion/postssalle">
      ...
      <Card>
        <Card.Body>
          <Card.Title className="display-1">block posts ultilizateurs</Card.Title>
          <Card.Text>liste des block posts uliisateurs</Card.Text>
        </Card.Body>
      </Card>
    </Container>
