 ...
 import React,{useEffect} from 'react';
    ...
    import Postssspendientes from '../../components/home/Postssspendientes';
    ...
    let scroll = 0;
     ...
     const Saladefiestas = () => {
      ...
      const { auth, homepostaprove } = useSelector((state) => state);
    ...
    <i className="fas fa-bars" />
          ...
          <Card.Body>
            ...
            <Card.Text>liste des posts de salle de fete</Card.Text>
          </Card.Body>
    
      </Container>
             {
                homepostaprove.loading
                  ? <img src={LoadIcon} alt="loading" className="d-block mx-auto" />
                  : (homepostaprove.result === 0 && homepostaprove.length === 0)
